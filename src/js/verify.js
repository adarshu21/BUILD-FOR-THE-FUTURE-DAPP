...
function verifyAdminLogin() {
    ...
    // Perform admin login verification logic here
    if (adminUsername === 'admin' && adminPassword === 'password') {
        // Admin login successful
        alert("Admin login successful. Redirecting to the admin portal.");
        window.location.href = "./AdminPortal.html"; // Redirect to the admin portal page
    } else {
        // Admin login failed
